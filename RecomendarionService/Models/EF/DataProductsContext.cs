...
namespace RecomendarionService.Models.EF
{
    public partial class DataProductsContext : DbContext
    {
        ...
        public virtual DbSet<ProductosLfgc> ProductosLfgc { get; set; }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductosLfgc>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("productos_lfgc");
                ...
                entity.Property(e => e.Temporada).IsRequired();
